            ...
            formatters = {
                ...
                prettier_md = {
                    ...
                    args = function()
                        ...
                        return { "--prose-wrap", "always", "--print-width", tostring(width), "--parser", "markdown" }
                    end,
                },
            },
        ...
        vim.keymap.set("n", "<leader>mi", function()
            ...
            if #formatters == 0 then
                ...
                for _, formatter in ipairs(formatters) do
                    table.insert(formatter_names,
                        formatter.name .. " (" .. (formatter.available and "tillgänglig" or "ej tillgänglig") .. ")")
                end
